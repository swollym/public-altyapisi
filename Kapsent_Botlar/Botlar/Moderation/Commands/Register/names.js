...
class Names extends Command {
    ...
    async run(client, message, args, embed) {
        ...
        if (!kapsent.commandsChannel.some(kanal => message.channel.id.includes(kanal)) && message.channel.id !== kapsent.welcomeChannel) return message.reply(`**UYARI:** Bu komutu yalnızca <#${kapsent.welcomeChannel}> kanalında kullanabilirsin!`).sil(10)
